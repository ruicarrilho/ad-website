      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-8">
          <div className="text-center mb-8">
            <h1 className="font-heading text-3xl font-bold text-primary mb-2">{t('auth.createAccount')}</h1>
            <p className="text-slate-600">{t('auth.signUpStart')}</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6" data-testid="register-form">
            <div className="space-y-2">
              <Label htmlFor="name" data-testid="name-label">{t('auth.fullName')}</Label>
              <Input
                id="name"
                name="name"
                type="text"
          ...
          <p className="text-center text-sm text-slate-600 mt-6">
            {t('auth.haveAccount')}{' '}
            <Link to="/login" data-testid="login-link" className="text-primary font-medium hover:underline">
              {t('auth.signIn')}
            </Link>
          </p>
        </div>
